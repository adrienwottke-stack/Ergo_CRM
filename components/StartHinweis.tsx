...
export default function StartHinweis({ phase }: { phase:string }) {
  ...
  return <section aria-label="Dein nächster Startschritt" className={`${card} space-y-3 p-5 sm:p-6`}>
    <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Dein nächster Schritt</p>
    <h2 className="text-2xl font-semibold">{text[0]}</h2><p className="text-slate-600">{text[1]}</p>

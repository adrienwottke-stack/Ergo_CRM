...
export const config = {
  ...
  // Login.
  matcher: [
    "/((?!login|einladung|neues-passwort|start|offline|api/cron|api/webhooks|kalender/feed|bericht|anfrage|emil/|manifest\\.webmanifest|sw\\.js|icon-|apple-touch-icon\\.png|_next/static|_next/image|favicon\\.ico|.*\\.svg$).*)",
  ],
};
